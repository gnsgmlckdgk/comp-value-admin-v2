...
/**
 * 코인 자동매매 프로그램 로그 실시간 추적 팝업 페이지
 * - 독립 브라우저 창으로 열림
 * - 폴링 방식을 통한 실시간 로그 스트리밍
 * - 검색 기능 (Ctrl+F)
 */
export default function CointradeLogStreamPopup() {
    ...
    return (
        <div className="h-screen w-screen flex flex-col bg-slate-50 dark:bg-slate-900">
            {/* 헤더 */}
            <div className="flex items-center justify-between px-4 sm:px-6 py-3 border-b border-slate-200 dark:border-slate-700 bg-gradient-to-r from-orange-500 to-red-600 shadow-lg">
                ...
                {showSearch && (
                    <div className="flex items-center gap-2 p-2 bg-slate-100 dark:bg-slate-700 rounded-lg">
                        <input
                            ...
                            className="flex-1 px-3 py-1.5 text-sm rounded border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 text-slate-900 dark:text-white outline-none focus:ring-2 focus:ring-orange-500"
                        />
                        <label className="flex items-center gap-1 text-xs text-slate-700 dark:text-slate-300 cursor-pointer whitespace-nowrap">
                            <input
                                ...
                                className="w-3.5 h-3.5 text-orange-600 rounded focus:ring-2 focus:ring-orange-500"
                            />
                            <span>대소문자</span>
                        </label>
                            ...
                            return (
                                <div
                                    ...
                                    className={`text-sm leading-relaxed px-2 py-1 rounded transition-all ${isCurrentResult
                                        ? 'bg-orange-900/50 dark:bg-orange-900/70 ring-2 ring-orange-500'
                                        : isSearchResult
