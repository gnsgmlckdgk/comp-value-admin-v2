...
const TABLE_COLUMNS = [
    ...
    },
    {
        ...
        render: (value, row) => {
            ...
            const isUndervalued = price && Number(value) > Number(price);
            return (
                <span className={isUndervalued ? 'font-bold text-green-600 dark:text-green-400' : 'text-slate-600 dark:text-slate-300'}>
